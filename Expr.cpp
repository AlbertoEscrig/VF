...
public:
  ...
  TTensor<d, r1 - 1u>
  Div(this TSelf const &, TCelda<d> const &) requires (r1 > 0u);
...
// -------------------------------------------------------------------------------------- Operadores
  ...
  template<CDimRanExpr<d, r1> U>
  TExprBinaria<d, r1, TSelf, U, std::plus<>>
  operator +(this TSelf const &lhs, U const &rhs)
    { return {lhs, rhs}; }
  ...
  template<CDimRanExpr<d, r1> U>
  TExprBinaria<d, r1, TSelf, U, std::minus<>>
  operator -(this TSelf const &lhs, U const &rhs)
    { return {lhs, rhs}; }
  ...
  template<CDimExpr<d> U, std::size_t r2 = RangoExpr<U>>
  TExprBinaria<d, r1 + r2, TSelf, U, std::multiplies<>>
  operator *(this TSelf const &lhs, U const &rhs)
    { return {lhs, rhs}; }
  ...
  template<CDimRanExpr<d, 0u> U>
  TExprBinaria<d, r1, TSelf, U, std::divides<>>
  operator /(this TSelf const &lhs, U const &rhs)
    { return {lhs, rhs}; }
  ...
  template<CDimExpr<d> U, std::size_t r2 = RangoExpr<U>>
  TExprBinaria<d, r1 + r2 - 2u, TSelf, U, std::bit_and<>>
  operator &(this TSelf const &lhs, U const &rhs) requires (r1 >= 1u && r2 >= 1u)
    { return {lhs, rhs}; }
  ...
  template<CDimExpr<d> U, std::size_t r2 = RangoExpr<U>>
  TExprBinaria<d, r1 + r2 - 4u, TSelf, U, std::logical_and<>>
  operator &&(this TSelf const &lhs, U const &rhs) requires (r1 >= 2u && r2 >= 2u)
    { return {lhs, rhs}; }
  ...
  template<CDimRanExpr<d, r1> U>
  TExprBinaria<3u, 1u, TSelf, U, std::bit_xor<>>
  operator ^(this TSelf const &lhs, U const &rhs) requires (d == 3u && r1 == 1u)
    { return {lhs, rhs}; }
...
TExprBase<T<d, r1, TRest...>>::Div(this TSelf const &Self,
                                   TCelda<d> const &Celda) requires (r1 > 0u)
{
