...
// -------------------------------------------------------------------------------------- Operadores
  ...
  template<CDimExpr<d> U>
  TExprBinaria<d, r1 + RangoExpr<U>, TSelf, U, std::multiplies<>>
  operator *(this TSelf const &lhs, U const &rhs)
    { return {lhs, rhs}; }
  ...
  template<CDimExpr<d> U>
  TExprBinaria<d, r1 + RangoExpr<U> - 2u, TSelf, U, std::bit_and<>>
  operator &(this TSelf const &lhs, U const &rhs)
    { return {lhs, rhs}; }
  ...
  template<CDimExpr<d> U>
  TExprBinaria<d, r1 + RangoExpr<U> - 4u, TSelf, U, std::logical_and<>>
  operator &&(this TSelf const &lhs, U const &rhs)
    { return {lhs, rhs}; }
